...
//  The new instance from the constructor function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//  not bound to anything and just inherits from the parent which is the window.
// 3. Explain why "this" is different when an arrow function is used.
//  I think arrow functions make the scope global.
